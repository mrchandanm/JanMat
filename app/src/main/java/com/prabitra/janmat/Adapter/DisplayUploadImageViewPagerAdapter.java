...
public class DisplayUploadImageViewPagerAdapter extends PagerAdapter {
    private Context mContext;
    private ArrayList<String> imagesList;

    public DisplayUploadImageViewPagerAdapter(Context mContext, ArrayList<String> imagesList) {
